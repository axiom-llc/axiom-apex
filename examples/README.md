...
Autonomous goal-driven research agent. Self-directs across a SEARCH/THINK/DONE loop, pulling from public APIs (Wikipedia, HackerNews, DuckDuckGo, Reddit), reasoning over accumulated knowledge, and producing a final Markdown report.
