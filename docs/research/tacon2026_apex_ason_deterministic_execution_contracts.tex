...
bounds on individual agent actions. ASON\textquotesingle s
distinguishing contribution is enforcement at the API boundary:
blast-radius classification, tool allowlisting, and step-count limits
are validated against the plan structure before any execution begins,
with no comparator in the cited frameworks.
...
Layer}\label{5-ason-policy-enforcement-layer}
