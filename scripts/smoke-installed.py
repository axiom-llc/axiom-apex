...
for name, version, module in [('axiom-rag', '1.5.0', rag), ('axiom-apex', '3.1.1', apex)]:
...
print('PASS: installed APEX 3.1.1 with RAG 1.5.0, prompt and RSI imports; no provider calls')
